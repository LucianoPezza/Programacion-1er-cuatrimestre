...
void mostrarArrayProductosConProveedor(eProducto listadeproductos[],int tamprod,eProveedor listadeproveedor[],int tamprov)
{
    int i;
    int j;
    for(i=0; i<tamprod; i++)
...
void mostrarArrayProveedorConProducto(eProveedor listadeproveedor[],int tamprod,eProducto listadeproductos[],int tamprov)
{
    int i;
    int j;
    for(i=0; i<tamprod; i++)
...
void inicializarProveedor(eProveedor listaProveedor[], int cant)
{
    int i;
    int id[3]= {1,2,3};
    ...
    for(i=0; i<3; i++)
    {
        ...
        strcpy(listaProveedor[i].cuilt, cuilt[i]);
        strcpy(listaProveedor[i].duenio, duenio[i]);
        listaProveedor[i].id[i]=id[i];
    ...
    {
        eProveedor Proveedorretornado;

        printf("Ingrese duenio: ");
        fflush(stdin);
        gets(Proveedorretornado.duenio);

        printf("Ingrese localidad: ");
        fflush(stdin);
        gets(Proveedorretornado.localidad);

        printf("Ingrese cuilt: ");
        fflush(stdin);
        gets(Proveedorretornado.cuilt);

        printf("Ingrese descripcion: ");
        fflush(stdin);
        gets(Proveedorretornado.descripcion);



        return Proveedorretornado;
    }
